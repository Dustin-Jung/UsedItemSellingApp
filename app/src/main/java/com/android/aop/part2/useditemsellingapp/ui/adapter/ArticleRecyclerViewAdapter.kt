package com.android.aop.part2.useditemsellingapp.ui.adapter
...
class ArticleRecyclerViewAdapter(val onItemClicked: (ArticleModel) -> Unit) :
    RecyclerView.Adapter<ArticleViewHolder>() {

    private val articleList = mutableListOf<ArticleModel>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ArticleViewHolder {
        val binding = ItemArticleRecyclerviewBinding.inflate(
...
class ArticleViewHolder(val binding: ItemArticleRecyclerviewBinding) :
